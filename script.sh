...
aws s3 cp ./lambda-code.zip s3://soap-transformer-$ACC_ID/
aws cloudformation create-stack --stack-name soap-pattern-stack --template-body file://cloudformation-template.json
# sam build
